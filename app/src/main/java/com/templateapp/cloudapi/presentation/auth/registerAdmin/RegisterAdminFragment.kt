...
class RegisterAdminFragment : BaseAuthFragment() {
    ...
    private val viewModel: RegisterAdminViewModel by viewModels()
    ...
    private val webInteractionCallback = object : WebAppInterface.OnWebInteractionCallback {
        ...
        override fun onSuccess(email: String) {
            CoroutineScope(Main).launch {
                viewModel.onTriggerEvent(RegisterAdminEvents.OnRegistered)
            }
        }
            ...
            processQueue(
                ...
                stateMessageCallback = object : StateMessageCallback {
                    override fun removeMessageFromStack() {
                        viewModel.onTriggerEvent(RegisterAdminEvents.OnRemoveHeadFromQueue)
                    }
                }
            )
    ...
    private fun loadPasswordResetWebView() {
        ...
        webView.loadUrl(Constants.REGISTER_ADMIN_URL)
